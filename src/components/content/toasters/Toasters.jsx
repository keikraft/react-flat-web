    ...
    return (
      <div>
        ...
        <div className="toaster-form">
          <Input type="text" placeholder="Toast Message" theme={this.props.theme} icon="message" value={this.state.toastMessage} error={this.state.toastMessageError} onChange={this.handleMessageInputOnChange} />
...
Toasters.propTypes = ToastersPropTypes;
