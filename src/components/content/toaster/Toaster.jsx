    ...
    return (
      <div>
        ...
        <div className="toaster-config">
          <div className="config-column">
            ...
            <RadioGroup name="toastPosition" value={this.state.toastPosition} onChange={this.handleToastPositionButtonChange}>
              <RadioButton label="Top" value="top" checked />
          ...
          <div className="config-column">
            ...
            <RadioGroup name="toastSide" value={this.state.toastSide} onChange={this.handleToastSideButtonChange}>
              ...
              <RadioButton label="Right" value="right" checked />
            </RadioGroup>
          </div>
          <div className="config-column">
            ...
            <RadioGroup name="toastType" value={this.state.toastType} onChange={this.handleToastTypeButtonChange}>
              <RadioButton label="Info" value="info" theme="blue" checked />
        ...
        <div className="toaster-form">
          ...
          <Input type="text" placeholder="Toast Message" theme="orange" icon="message" value={this.state.toastMessage} onChange={this.handleMessageInputOnChange} error={this.state.toastMessageError} />
          <Button text="Create Toast" onMouseUp={this.handleCreateToastButtonMouseUp} raised />
        </div>
