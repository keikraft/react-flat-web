  ...
  return (
    <div>
      <div>
        ...
        <XButton flat text="Themed" theme={theme} icon="bookmark" />
      ...
      <div>
        ...
        <XButton raised text="Themed" theme={theme} icon="bookmark" />
      ...
      <div>
        ...
        <XButton circular mini icon="star" theme={theme} />
        <XButton circular inverse icon="star" theme={theme} />
        <XButton circular mini href="https://github.com/k3ira" icon={<GithubIcon />} theme="purple" />
      </div>
      <div>
        <h2>Waveless</h2>
        <XButtonWaveless raised text="Default" />
        <XButtonWaveless raised text="Themed" theme={theme} icon="bookmark" />
        ...
        <XButtonWaveless circular mini icon="star" theme={theme} />
      </div>
    </div>
  );
};
